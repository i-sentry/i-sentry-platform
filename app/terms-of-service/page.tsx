...
const TermsOfService = () => {
  ...
  return (
    <section className="relative pb-24 pt-28 lg:pt-[180px]">
      {/* SVG BG */}
      <svg
      ...
      <div className="wrapper max-w-5xl">
        ...
        <article className="space-y-4">
          <div className="space-y-2">
            <h2 className="text-xl font-medium text-white">Terms of service</h2>
            <p className="font-light text-white">
              Last Updated: {updatedAt?.toLocaleDateString()}
            </p>

            <p className="font-light text-grey-200">
              I-Sentry Technologies (&quot;we,&quot; &quot;our,&quot;
              &quot;us&quot;) offers access to our website and services under
              these Terms of Service. By using our website, you agree to these
              terms. If you disagree, you may not access or use our services.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              I-Sentry Technologies is committed to delivering innovative
              digital solutions for businesses and developers. These Terms
              govern the use of our website and services, including product
              design, software development, and mentorship programs.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              For details on our services, including processes and outcomes,
              please refer to our Services page. Our mentorship program includes
              information about our mentees, past projects, and testimonials
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              When using our website or services, users agree to:
            </p>
            ...
            <ul className="list-disc space-y-3 pl-4 text-grey-200">
              ...
              <li>
                Avoid unlawful activity or rights violations against I-Sentry
                Technologies or others.
              </li>
              <li>
                Ensure that materials submitted (e.g., feedback, testimonials)
                are original and do not infringe on intellectual property
                rights.
              </li>
            </ul>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              Content on the I-Sentry Technologies website, including design
              elements, animations, and interactive components, is the
              intellectual property of I-Sentry Technologies. Unauthorized use,
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              Our Careers page provides job application tracking for users
              interested in joining our team. Applicants must provide accurate
              information, and falsified submissions may result in application
              termination.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              The Workshop page details our mentorship program, its benefits,
              and participant progress. Mentees are expected to adhere to
              I-Sentry Technologies&apos; rules and guidelines. Testimonials by
              former mentees are displayed to highlight the program&apos;s
              impact.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              Our website is fully responsive, with interactive animations and
              micro-interactions. Users should use compatible devices and
              browsers to experience it optimally. We reserve the right to
              update or modify the site layout and functionality at any time.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              Refer to our Privacy Policy for details on how we collect, use,
              and disclose user information. By using our website, you agree to
              our data practices outlined in the Privacy Policy.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              I-Sentry Technologies is not liable for any direct or indirect
              damages arising from the use of our services or website, including
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              We reserve the right to suspend or terminate service access at our
              sole discretion, without notice, for reasons including violations
          ...
          {/* Governing Law  */}
          <div className="space-y-2">
            <h2 className="text-xl font-medium text-white">Governing Law</h2>
            <p className="font-light text-grey-200">
              These Terms of Service are governed by the laws of [Your
              Country/State]. Disputes will be resolved in the courts located in
              [Jurisdiction].
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              Changes to the Terms of Service We may update these Terms from
              time to time. Changes will be posted here with an updated
              effective date. Continued use of the site implies acceptance of
              revised terms.
            </p>
          </div>
