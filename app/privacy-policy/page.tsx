        ...
        <article className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              ...
              &quot;us&quot;) values your privacy and is committed to protecting
              your personal data. This Privacy Policy explains how we collect,
              use, and disclose information through our website and services. By
          ...
          <div className="space-y-2">
            ...
            <ol className="list-[lower-alpha] space-y-3 pl-4 text-grey-200">
              <li>
                <span className="font-light text-grey-200">
                  Personal Information
                </span>
                <ul className="mt-2 list-disc pl-2 font-light text-grey-200">
                  <li>
                    When you engage with our services (e.g., applying for a job,
                    joining our mentorship program), we may collect personal
                    information such as your name, email address, phone number,
                    and other details you provide.
                  </li>
                  <li>
                    If you submit an inquiry or contact us, we may collect
                    information relevant to your inquiry, such as your company
              ...
              <li>
                <span className="font-light text-grey-200">Usage Data</span>
                <ul className="mt-2 list-disc pl-2 font-light text-grey-200">
                  <li>
                    We collect data about how our website is accessed and used
                    (&quot;Usage Data&quot;). This data may include information
                    such as your IP address, browser type, pages visited, and
                    the time spent on those pages. We may also collect
                    information about your interaction with our site&apos;s
                    interactive elements, such as animations, hover effects, and
                    filtering system
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul className="mt-2 list-disc pl-2 font-light text-grey-200">
                  <li>
                    ...
                    remember preferences, and analyze usage. You can choose to
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc space-y-3 pl-4 text-grey-200">
              <li>
                To Provide Services: We use your personal data to provide
                services, including responding to inquiries, processing job
                applications, and managing our mentorship program.
              </li>
              <li>
                Improve User Experience: Usage data helps us optimize our
                website and improve navigation, layout, and interactive
                elements.
              </li>
              <li>
                Communications: We may send you updates, notifications, or
                promotional content related to I-Sentry Technologies. You can
                opt out of receiving these communications at any time.
              </li>
              <li>
                Legal Compliance: We may use your data to comply with legal
                obligations or to enforce our Terms of Service.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc space-y-3 pl-4 text-grey-200">
              <li>
                ...
                website, conducting our business, or providing our services.
              </li>
              <li>
              ...
              <li>
                ...
                sale of assets, we may transfer your personal information to the
          ...
          {/* YOUR RIGHT */}
          <div className="space-y-2">
            <h2 className="text-xl font-medium text-white">Your right</h2>
            <p className="font-light text-grey-200">
          ...
          <div className="space-y-2">
            ...
            <p className="font-light text-grey-200">
              ...
              Updated&quot; date. Your continued use of the website after any
